            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="grid" role="tabpanel">
                    <div class="row row-cards">
                                    ...
                                    <div class="d-flex align-items-center px-2">
                                        ...
                                        <div class="ml-auto text-muted text-right">
                                            ...
                                            <div class="modal fade" id="edit{{ $list->id_stade }}"
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" style="max-width: 800px;">
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="POST"
                                                            action="{{ route('stades.update', $list->id_stade) }}"
                                                                ...
                                                                <div class="row clearfix">
                                                                    <div class="col-md-12 col-sm-12">
                                                                        <div class="form-group">
                                                                            <label>Libelle</label>
                                                                            <input value="{{ $list->libelle_stade }}"
                                            ...
                                            <a href="javascript:void(0)" class="icon d-none d-md-inline-block ml-3"
                                                ...
                                                data-bs-target="#delete{{ $list->id_stade }}"><i class="fe fe-trash mr-1"
                                                    style="color: red"></i></a>
                                            <div class="modal fade" id="delete{{ $list->id_stade }}"
                                                data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                                aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('stades.destroy', $list->id_stade) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <div class="modal-body text-left">
                        ...
                        @empty
                            <em>
                                Pas de stade disponible. Vous pouvez cliquer sur <strong style="color: red;">Ajouter
                                    stade</strong> au dessus...
                            </em>
                        @endforelse
                    </div>
                </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <form class="card-body" method="POST" action="{{ route('stades.store') }}"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="row clearfix">
                                        <div class="col-md-12 col-sm-12">
